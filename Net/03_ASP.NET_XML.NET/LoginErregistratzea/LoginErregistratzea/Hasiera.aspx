...
<body>
    ...
    <p>
        <img alt="" src="/irudiak/giltza.jpg" 
            ...
            style="z-index: 1; left: 604px; top: 130px; position: absolute; height: 173px; width: 206px;" /><asp:Label 
            ID="Label2" runat="server" Text="LABORATEGIA 6 XML"></asp:Label>
    </p>
    <p>
        <a href="mailto:karlos@ehu.es">karlos@ehu.es</a>&nbsp;&nbsp;&nbsp; karlos</p>
    <p>
        <a href="mailto:jipartzu@ehu.es">jipartzu@ehu.es</a>&nbsp;&nbsp; a</p>
    <p>
