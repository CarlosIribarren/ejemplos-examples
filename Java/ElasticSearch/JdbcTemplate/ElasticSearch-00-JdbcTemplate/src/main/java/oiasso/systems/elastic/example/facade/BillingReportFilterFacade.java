package oiasso.systems.elastic.example.facade;
...
public interface BillingReportFilterFacade {
	 ...
	 * @return List of unique spots of billing. The maximum date and the minimum date of all spots are also returned.
	 ...
	 * @return List with all devices. The maximum date and the minimum date of these spot are also returned.
	 * @throws ElasticSearchConsultException
	 */
