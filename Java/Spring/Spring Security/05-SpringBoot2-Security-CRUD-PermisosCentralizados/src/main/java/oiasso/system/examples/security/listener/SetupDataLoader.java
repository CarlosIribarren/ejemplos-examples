...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
    	...
    	if(usuarioRepository.findAll().isEmpty()) {
    		...
    		//Crear privilegio acceso-gestion-roles
        	PrivilegioEntity privilegioAccesoGestionRoles = new PrivilegioEntity();
        	privilegioAccesoGestionRoles.setNombre("acceso-gestion-roles");
        	// Se guarda el objeto y se recupera el guardado en BD que ya tiene el id, ya que el id esta definido como autonumerico
        	privilegioAccesoGestionRoles = privilegioRepository.save(privilegioAccesoGestionRoles);           	
        	...
        	privilegiosAdmin.add(privilegioAccesoGestionRoles);
